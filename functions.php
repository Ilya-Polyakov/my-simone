...
function my_simone_scripts() {
        ...
        wp_enqueue_style('my-simone-google-fonts', 'http://fonts.googleapis.com/css?family=Lato:400,400italic,700,900,900italic|PT+Serif:400,400italic,700,700italic');
        
        wp_enqueue_style('my-simone-fontawesome', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css');
            
        wp_enqueue_script( 'my-simone-superfish', get_template_directory_uri() . '/js/superfish.min.js', array('jquery'), '20150803', true );
        
        wp_enqueue_script( 'my-simone-superfish-settings', get_template_directory_uri() . '/js/superfish-settings.js', array('my-simone-superfish'), '20150803', true );
        
        wp_enqueue_script( 'my-simone-hide-search', get_template_directory_uri() . '/js/hide-search.js', array('jquery'), '20150803', true );
